...
public class Hierarchy<V> {
    ...
    public class Family implements Iterable<HierarchyNode<V>> {
        ...
        public HierarchyNode<V> filter(final Filter<HierarchyNode<V>> filter) {
            forEach(new Action<HierarchyNode<V>>() {
                @Override
                public boolean action(HierarchyNode<V> t) {
                    return filter.onFilter(t) && filter.onMatcher(t);
                }
            });
            return null;
        }
    ...
    public static <T extends ViewHierarchyNode> Hierarchy of(T t) {
