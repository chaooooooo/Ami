 ...
 * @since 2018/9/28
 */
public class FPSPlugin extends AmiPlugin<AmiPluginFragment,FPSSettings, FPSComponent> implements AmiSettings.OnSettingsChangeListener {
    ...
    @Override
    public FPSComponent createComponent() {
        return new FPSComponent(this);
    }
