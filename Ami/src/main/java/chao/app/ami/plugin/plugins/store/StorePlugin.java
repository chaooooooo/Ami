 ...
 * @since 2018/10/7
 */
public class StorePlugin extends AmiPlugin<StoreFragment, StoreSettings, StorePane> {
    @Override
    public StoreSettings createSettings() {
        return new StoreSettings();
    }

    @Override
    protected StoreFragment createFragment() {
