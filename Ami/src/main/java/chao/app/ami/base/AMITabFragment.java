 ...
 * @since 2018/10/13
 */
public abstract class AMITabFragment extends AMISupportFragment {
    ...
    public int getLayoutID() {
        return R.layout.ami_tab_fragment;
    }
