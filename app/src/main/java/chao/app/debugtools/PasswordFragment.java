 ...
 * @since 2018/10/7
 */
@LayoutID(R.layout.password_fragment)
public class PasswordFragment extends AMISupportFragment {
    ...
    public void setupView(View layout) {
        pwdEdit = findView(R.id.password);
        ...
        pwdEdit.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                if (ViewUtil.inPassword(pwdEdit)) {
                    ViewUtil.hidePassword(pwdEdit);
                } else {
                    ViewUtil.showPassword(pwdEdit);
                }
